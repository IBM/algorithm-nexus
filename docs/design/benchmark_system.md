...
Thanks to `ado` data recording capabilities, if one instance in a sweep fails
...
| Requirement | Name                                 | Fulfillment Strategy | Component           | Proposed Solution                                                                                                                                                                                                                                                                                                                          |
| ----------- | ------------------------------------ | -------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **REQ 2.1** | Benchmark Experiment Registration    | Technology + Process | nexus               | Registering benchmark experiments package involves adding information on the package and experiments used to the metadata of a nexus package AND validating that all packages references can be installed together. Packages provided via any mechanism outlined in REQ 3.2 can be registered. [PENDING: Nexus Test Dependencies Handling] |

# Using the BiomedRNA 47M WCED Multitask Model

This guide provides instructions on how to use the BiomedRNA 47M WCED Multitask
model for single-cell RNA embedding generation using vLLM serving.

## Overview

The BiomedRNA 47M WCED Multitask model
(`ibm-research/biomed.rna.llama.47m.wced.multitask.v1.vllm`) is a 47M parameter
...
MODEL_REPO = WCED_MULTITASK_MODEL  # "ibm-research/biomed.rna.llama.47m.wced.multitask.v1.vllm"
